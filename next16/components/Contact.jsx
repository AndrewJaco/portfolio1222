      ...
      <div id={styles.contactContainer}>
        <ul id={styles.contactGroup}>
          <div id={styles.contactsA}>
            ...
            <li><a href='https://www.facebook.com/profile.php?id=9624949' target="_blank" rel="noreferrer" className={styles.linkItem}><Image src="/img/facebook.svg" alt="Facebook" width={24} height={24} /></a></li>
